...
public:
     ...
     */
     void WriteCommand( HFRadioCommands_t opcode, uint8_t *buffer, uint16_t size );
     ...
     */
     void ReadCommand( HFRadioCommands_t opcode, uint8_t *buffer, uint16_t size );
...
public:
    ...
    SPIClass *RadioSpi;                                  //!< The SPI object used to communicate with the radio
    Stream *RadioUart;                              //!< The UART object used to communicate with the radio
