...
#define AnalogIn int
#define PinName int
#define DigitalOut int
#define DigitalIn int
#define DigitalInOut int
#define InterruptIn int
#define NC -1
#include "Arduino.h"
#include <SPI.h>
/*!
...
typedef struct
{
    ...
    void ( *rxError )( HFIrqErrorCode_t errCode );    //!< Pointer to a function run on reception error
    void ( *rangingDone )( HFIrqRangingCode_t val );  //!< Pointer to a function run on ranging terminated
...
protected:
     ...
     */
    void ( *rxError )( HFIrqErrorCode_t errCode );
     ...
     */
    void ( *rangingDone )( HFIrqRangingCode_t val );
...
public:
     ...
     *
     */
    Radio( HFRadioCallbacks_t *callbacks )
    {
     ...
     */
    virtual HFRadioStatus_t GetStatus( void ) = 0;
