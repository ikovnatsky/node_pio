...
double Sx1280RangingCorrection::GetRangingCorrectionPerSfBwGain( const HFRadioLoRaSpreadingFactors_t sf, const HFRadioLoRaBandwidths_t bw, const int8_t gain){
...
double Sx1280RangingCorrection::ComputeRangingCorrectionPolynome(const HFRadioLoRaSpreadingFactors_t sf, const HFRadioLoRaBandwidths_t bw, const double median){
    uint8_t sf_index, bw_index;
