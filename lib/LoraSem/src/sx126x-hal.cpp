 ...
 */
extern void  DoWaitBusy(void);
#define WaitOnBusy( )          DoWaitBusy()
//while( BUSY == 1 ){ }
...
void SX126xHal:: RadioNssSet(uint8_t val)
{
digitalWrite(RadioNss,val);
}
            ...
            antSwitchPower( antSwPower )
{
  //  CreateDioPin( dio1, DIO1 );
   ...
   // CreateDioPin( dio3, DIO3 );
    //RadioSpi = new SPIClass( *mosi, *miso, *sclk );
