...
int frequency_step = 8*100;  // Frequency step for CW generator
...
void dac_cosine_disable(dac_channel_t channel)
{
    ...
    switch(channel) {
        case DAC_CHANNEL_1:
            ...
            //CLEAR_PERI_REG_BITS(SENS_SAR_DAC_CTRL2_REG, SENS_DAC_INV1, 2, SENS_DAC_INV1_S);
            break;
        case DAC_CHANNEL_2:
     ...
     if (f==0)
       {
        ...
        frequency_step = (1 + clk_8m_div)*65536*f/ RTC_FAST_CLK_FREQ_APPROX;
